        ...
        animate: function(options) {
            ...
            if (options.type == 'sprite' && options.fps) {
                ...
                var animate = function(el) {
                    ...
                    } else if ($._spritely.instances[el_id]['current_frame'] == options.no_of_frames - 1) {
                    ...
                    if (options.rewind == true) {
                        if ($._spritely.instances[el_id]['current_frame'] <= 0) {
                            $._spritely.instances[el_id]['current_frame'] = options.no_of_frames - 1;
                        } else {
                            $._spritely.instances[el_id]['current_frame'] = $._spritely.instances[el_id]['current_frame'] - 1;
                        };
                    } else {
                        if ($._spritely.instances[el_id]['current_frame'] >= options.no_of_frames - 1) {
                    ...
                    var xPos =  -($._spritely.instances[el_id]['current_frame']%options.frames_per_line)*w;
                    // console.log("frame: " + $._spritely.instances[el_id]['current_frame'],xPos,yPos);
                    el.css('background-position', xPos + 'px ' + yPos);
